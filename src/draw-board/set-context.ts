import { PolarPoint, getCartesian, validPoint } from './polar-point';
...
export const setContext = (
  ...
  // Set origin to center of canvas (0,0)
  ...
  if (validPoint(centerPoint) && centerPoint.radius !== 0) {
    const center = getCartesian(centerPoint);
